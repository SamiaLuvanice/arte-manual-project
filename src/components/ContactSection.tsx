          ...
          {[
            {
              ...
              desc: "Respondemos suas mensagens com carinho e agilidade.",
            },
            {
              icon: Heart,
              title: "Peças Personalizadas",
              desc: "Criamos peças exclusivas sob medida para você.",
            },
            {
              icon: Clock,
              title: "Prazo Combinado",
              desc: "Trabalhamos com transparência em cada encomenda.",
            },
          ].map((item) => (
            <div
              key={item.title}
              className="rounded-2xl border border-border bg-background p-6 text-center transition-shadow duration-300 hover:shadow-md"
            >
